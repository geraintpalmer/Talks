...
\begin{frame}
  \frametitle{My Journey to Code}
	\begin{tikzpicture}
		...
		\node (python) [words, yshift=-3cm, xshift=1.125cm] {Taught Python};
		\pause
		\draw (2.25, 0) -- (2.25, -0.5);
		\node (python) [words, yshift=-1cm, xshift=2.25cm] {Googled};
		\pause
    \draw (3.375, 0) -- (3.375, -2.5);
    \node (python) [words, yshift=-3cm, xshift=3.375cm] {Found a nice Text Editor};
    \pause
		\draw (4.5, 0) -- (4.5, -0.5);
		\node (python) [words, yshift=-1cm, xshift=4.5cm] {Installed my first Library};
		\pause
		\draw (5.625, 0) -- (5.625, -2.5);
		\node (python) [words, yshift=-3cm, xshift=5.625cm] {Pair Programmed};
		\pause
		\draw (6.75, 0) -- (6.75, -0.5);
		\node (python) [words, yshift=-1cm, xshift=6.75cm] {Discovered};
		\pause
		\draw (7.825, 0) -- (7.825, -2.5);
		\node (python) [words, yshift=-3cm, xshift=7.825cm] {Python-Namibia};
    \pause
    \draw (9.0, 0) -- (9.0, -0.5);
    \node (python) [words, yshift=-1cm, xshift=9cm] {Giving this Talk};
	\end{tikzpicture}
\end{frame}
...
% 8th slide, Rory the robot
\begin{frame}
  \frametitle{Rory The Robot}
  \begin{center}
  \includegraphics[width=3.4cm]{Images/rorythehandbot}
  \end{center}
\end{frame}
